...
$courseStmt = $pdo->prepare("
    SELECT c.*, c.level as course_level, ca.session_year, ca.semester, ca.assigned_date
    FROM courses c
...
$recentAttStmt = $pdo->prepare("
    ...
    LIMIT 10
");
$recentAttStmt->execute([$course_id]);
...
<style>
    ...
    .class-header .class-actions .btn {
        padding: 8px 20px;
        border-radius: 12px;
        font-weight: 600;
        font-size: 0.85rem;
    ...
    .class-header .class-actions .btn-light:hover {
    ...
    .quick-stat.grade { border-left-color: var(--warning-color); }
    .quick-stat.grade .stat-number { color: var(--warning-color); }
    ...
    @media (max-width: 768px) {
        .class-header { padding: 20px; }
        .quick-stats { grid-template-columns: repeat(2, 1fr); }
        .student-list-table { overflow-x: auto; }
    }
</style>
...
<div class="class-header">
    <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
        <div>
            <h3><i class="fas fa-book-open me-2"></i><?php echo htmlspecialchars($course['course_title'] ?? 'Class'); ?></h3>
            <div class="class-meta">
                ...
                <span><i class="fas fa-layer-group"></i> Level <?php echo htmlspecialchars($course['course_level'] ?? 'N/A'); ?></span>
...
<div class="quick-stats">
    ...
    <div class="quick-stat grade">
        <div class="stat-number"><?php echo $result_summary['published_count'] ?? 0; ?></div>
    ...
    <div class="col-md-3 col-sm-6">
        <div class="info-card">
            ...
            <div class="number">
                ...
                $active = 0;
                foreach ($students as $s) {
                    if (($s['student_status'] ?? '') == 'Active') $active++;
                }
                echo $active;
                ?>
            </div>
...
<div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
    ...
    <div class="d-flex gap-2">
        ...
        <button class="btn btn-outline-custom btn-sm" onclick="sendMessageToAll()">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div>
                                <div class="fw-semibold" style="font-size: 0.9rem;"><?php echo htmlspecialchars($fullName); ?></div>
                                <div class="text-muted" style="font-size: 0.7rem;">ID: <?php echo $student['student_id']; ?></div>
                            </div>
                        </div>
                    </td>
                    <td><span class="fw-semibold"><?php echo htmlspecialchars($student['matric_number']); ?></span></td>
                    <td style="font-size: 0.85rem;"><?php echo htmlspecialchars($student['email']); ?></td>
                    <td><?php echo htmlspecialchars($student['gender'] ?? 'N/A'); ?></td>
                    <td>
                        <span class="status-badge-sm status-<?php echo strtolower($student['student_status'] ?? 'active'); ?>">
                    ...
                    <td>
                        <div class="action-btn-group">
                            <a href="student_profile.php?id=<?php echo $student['student_id']; ?>" class="btn btn-primary btn-sm" title="View Profile">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="take_attendance.php?course=<?php echo $course_id; ?>&student=<?php echo $student['student_id']; ?>" class="btn btn-success btn-sm" title="Take Attendance">
                                <i class="fas fa-clipboard-check"></i>
                            </a>
                            <a href="message.php?student=<?php echo $student['student_id']; ?>" class="btn btn-info btn-sm" title="Send Message">
...
<script>
    ...
    function sendMessageToAll() {
        window.location.href = 'message.php?course=<?php echo $course_id; ?>&all=1';
    }
</script>
